...
<head>
	...
	<!-- 어트랙션 수정 스타일 -->
  <link href="${ contextPath }/resources/css/facility/attraction/attraction_modify.css" rel="stylesheet">
</head>
<body>
	    ...
	    <div class="modifyForm">
	        ...
	        <form action="${ contextPath }/attraction/modify.do" method="post" id="modify-form" enctype="multipart/form-data">
	            ...
	            <div class="field-group">
	                ...
	                <input type="text" id="attraction-name" placeholder="어트랙션명을 입력하세요." name="attractionName" value="${ attraction.attractionName }">
	            </div>
	            ...
	            <div class="field-group">
	                ...
	                <span class="map text-center text-primary">${ attraction.locationName }</span>
	            ...
	            <div class="field-group">
	                ...
	                <select class="attraction-status form-select text-center" id="attraction-status" name="status">
	            ...
	            <div class="field-group">
	                ...
	                <input type="radio" id="age-limit-n" name="ageLimitYN" value="N">
	            ...
	            <div class="field-group">
	                ...
	                <input type="radio" name="heightLimitYN" id="height-limit-n" value="N" checked>
	                <label class="form-check-label" for="height-limit-n">없음</label>
	
	                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	
	                <input type="radio" name="heightLimitYN" id="height-limit-y" value="Y">
	                ...
	                <div class="height-limit d-none">
	                    ...
	                    <select class="form-select text-center" name="heightLimitRange">
	                        <option>이상</option>
	                        <option>이하</option>
	                        <option>초과</option>
	                        <option>미만</option>
	            ...
	            <div class="field-group">
	                ...
	                <textarea class="mh-5" id="attraction-intro" name="attractionIntro">${ attraction.attractionIntro }</textarea>
	            </div>
