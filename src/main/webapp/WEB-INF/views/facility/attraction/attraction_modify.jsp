	    ...
	    <div class="modifyForm">
	        ...
	        <form action="${ contextPath }/attraction/modify.do" method="post" id="modify-form">
	            ...
	            <div class="field-group">
	                ...
	                <input type="text" id="attraction-name" placeholder="어트랙션명을 입력하세요." required name="attractionName" value="${ attraction.attractionName }">
	            </div>
	            ...
	            <div class="field-group">
	                ...
	                <input type="radio" id="age-limit-n" name="ageLimitYN">
