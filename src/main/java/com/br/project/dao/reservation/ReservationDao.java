...
public class ReservationDao {
	...
	public List<HashMap<String, Object>> selectAllReservation(PageInfoDto pi) {
		...
		return sqlSessionTemplate.selectList("reservationMapper.selectAllReservation", null, rowBounds);
	}
	// 내 예약 취소하기
	...
	public int selectAllReservationCount() {
		return sqlSessionTemplate.selectOne("reservationMapper.selectAllReservationCount");
	}
